...
{
    /// 请求物品兑换
    public sealed class NotifyGlobalConvertItemMessage : IProtocol
    {
        public const short MsgType = MessageType.MSG_NOTIFY_GLOBAL_CONVERT_ITEM;
        ...
        {
            var packet = new NotifyGlobalConvertItemMessage
            {
