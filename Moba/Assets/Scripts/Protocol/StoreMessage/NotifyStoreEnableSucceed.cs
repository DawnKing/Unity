...
{
    // 通知商店开启成功
    public sealed class NotifyStoreEnableSucceed : IProtocol
    {
        public const short MsgType = MessageType.MSG_NOTIFY_STORE_ENABLE_SUCCEED;
        ...
        {
            var packet = new NotifyStoreEnableSucceed
            {
                ntoreType = ntoreType,
